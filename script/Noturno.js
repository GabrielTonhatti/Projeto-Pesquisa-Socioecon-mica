function Noturno() {
    async function generateChart() {
        ...
        GerarGraficoPie(conhecimentoIdioma, opcConhecimentoLinguas, respNoturno, 50, labelsIdioma, DadosIdioma, 'Outros', 'Conhecimento em outros idiomas');
        ...
        GerarGraficoPie(Televisores, opcBuscaInformação, respNoturno, 51, labelsTelevisores, DadosTelevisores, 'Televisores', 'Busca por informação no seguinte meio de comunicação(Televisores)');
        ...
        GerarGraficoPie(internet, opcBuscaInformação, respNoturno, 52, labelsInternet, DadosInternet, 'Internet', 'Busca por informação no seguinte meio de comunicação(Internet)');
        ...
        GerarGraficoPie(revistas, opcBuscaInformação, respNoturno, 53, labelsRevistas, DadosRevistas, 'Revistas', 'Busca por informação no seguinte meio de comunicação(Revistas)');
        ...
        GerarGraficoPie(jornais, opcBuscaInformação, respNoturno, 54, labelsJornais, DadosJornais, 'Jornais', 'Busca por informação no seguinte meio de comunicação(Jornais)');
        ...
        GerarGraficoPie(Radio, opcBuscaInformação, respNoturno, 55, labelsRadio, DadosRadio, 'Radio', 'Busca por informação no seguinte meio de comunicação(Rádio)');
        ...
        GerarGraficoPie(RedesSociais, opcBuscaInformação, respNoturno, 56, labelsRedesSociais, DadosRedesSociais, 'Redes_Sociais', 'Busca por informação no seguinte meio de comunicação(Redes Sociais)');
        ...
        GerarGraficoPie(ConversaComAmigos, opcBuscaInformação, respNoturno, 57, labelsConversaComAmigos, DadosConversaComAmigos, 'Conversas_com_Amigos', 'Busca por informação no seguinte meio de comunicação(Conversas com Amigos)');
        ...
        GerarGraficoPie(LeJornal, opcLeJornal, respNoturno, 58, labelsLeJornal, DadosLeJornal, 'Le_Jornal', ' Frequência que leem jornal');
        ...
        GerarGraficoBar(assuntosQueLeem, opcAssuntosJornal, respNoturno, 59, labelsAssuntosQueLeem, DadosAssuntosQueLeem, 'Assuntos_que_Le', 'horizontalBar','Assuntos que mais leem')
    
        console.log(respNoturno[59])

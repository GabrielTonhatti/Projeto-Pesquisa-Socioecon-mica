function Noturno() {
    async function generateChart() {
        ...
        GerarGraficoPie(QtdLivros, opcQtdLivros, respNoturno, 60, labelsQtdLivros, DadosQtdLivros, 'Qtd_Livros', 'Quantos livros cada aluno lê por ano (em média)');
        ...
        GerarGraficoBar(leLivros, opcLeLivros, respNoturno, 61, labelsLeLivros, DadosLeLivros, 'Le_Livros', 'horizontalBar', "Gêneros de livros preferidos de cada aluno");
        ...
        GerarGraficoPie(atividadesVolutaria, opcAtividadeVolun, respNoturno, 62, labelsAtividadeVoluntaria,)
    */

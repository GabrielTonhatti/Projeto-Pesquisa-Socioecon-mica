function Matutino() {
    async function generateChart() {
        ...
        GerarGraficoPie(curso, opcCurso, respMatutino, 2, labelsCurso, DadosCurso, 'curso', 'Cursos')
        ...
        GerarGraficoBar(estado, opcEstado, respMatutino, 5, labelsEstado, DadosEstados, 'estado', 'bar', 'Estados');
        ...
        GerarGraficoBar(cidade, opcCidade, respMatutino, 6, labelsCidade, DadosCidade, 'MatutinoCidade', 'bar', 'Cidades');
        ...
        GerarGraficoPie(genero, opcGenero, respMatutino, 7, labelsGenero, DadosGenero, 'genero', 'Gênero');
        ...
        GerarGraficoPie(estadoCivil, opcEstadoCivil, respMatutino, 9, labelsEstadoCivil, DadosEstadoCivil, 'estado_civil', 'Estado Civil');
        ...
        GerarGraficoPie(portadores, opcPortador, respMatutino, 10, labelsPortadores, DadosPortadores, 'Portador_de_Necessidade', 'Portadores de Necessidades Especiais');
        ...
        GerarGraficoPie(ConvivePort, opcConvivePort, respMatutino, 11, labelsConvivePort, DadosConvivePort, 'convive_com_portador', 'Convive com Portadores de Necessidades Especiais');
        ...
        GerarGraficoPie(QtdFilhos, opcQtdFilhos, respMatutino, 12, labelsQtdFilhos, DadosQtdFilhos, 'qtd_de_filhos', "Quantidade de filhos de cada estudante");
        ...
        GerarGraficoPie(moraCom, opcMoraCom, respMatutino, 13, labelsMoraCom, DadosMoraCom, 'moram_com', "Com quem cada estudante mora");
        ...
        GerarGraficoPie(QtdMoradores, opcQtdMoradores, respMatutino, 14, labelsQtdMoradores, DadosQtdMoradores, 'QTD_de_pessoas_moram_junto', "Quantidade de pessoas que moram com cada aluno");
        ...
        GerarGraficoPie(SituacaoDomicilio, opcSituacaoDomi, respMatutino, 15, labelsSituacaoDomi, DadosSituacaoDomi, 'situacao_domicilio', "Situação do Domicílio")
        ...
        GerarGraficoBar(TempoMoradia, opcTempoMoradia, respMatutino, 16, labelsTempoMoradia, DadosTempoMoradia, 'tempo_moradia', 'bar', 'Tempo de moradia no domicílio(Em anos)');
        ...
        GerarGraficoPie(RendaMensal, opcRendaMensal, respMatutino, 17, labelsRendaMensal, DadosRendaMensal, 'salario_min', "Faixa de renda mensal da família do estudante (em Salários Mínimos)");
        ...
        GerarGraficoPie(QtdGeladeira, opc17QtdeCadaCoisa, respMatutino, 18, labelsQtdGeladeira, DadosQtdGeladeira, 'qtd_geladeira', "Quantidade de Geladeiras de cada aluno");
        ...
        GerarGraficoPie(QtdCelular, opc17QtdeCadaCoisa, respMatutino, 19, labelsQtdCelular, DadosQtdCelular, 'qtd_celular_comum', "Quantidade de celulares comuns de cada aluno");
        ...
        GerarGraficoPie(QtdMicroOndas, opc17QtdeCadaCoisa, respMatutino, 20, labelsQtdMicroOndas, DadosQtdMicroOndas, 'qtd_micro_ondas', 'Quantidade de micro-ondas de cada aluno');
        ...
        GerarGraficoPie(QtdNotebooks, opc17QtdeCadaCoisa, respMatutino, 21, labelsQtdNotebook, DadosQtdNotebooks, 'qtd_notebooks', 'Quantidade de Notebooks de cada aluno');
        ...
        GerarGraficoPie(Qtd_Maquina_de_Lavar, opc17QtdeCadaCoisa, respMatutino, 22, labelsMaquinaLavar, DadosMaquinaLavar, 'qtd_Maquina_de_Lavar', 'Quantidade de Máquinas de lavar roupa de cada aluno');
        ...
        GerarGraficoPie(Qtd_motoclicletas, opc17QtdeCadaCoisa, respMatutino, 23, labelsMotocicletas, DadosMotocicletas, 'qtd_motocicletas', 'Quantidade de Motocicletas de cada aluno');
        ...
        GerarGraficoPie(QtdAutomoveis, opc17QtdeCadaCoisa, respMatutino, 24, labelsAutomoveis, DadosAutomoveis, 'qtd_Automoveis', 'Quantidade de Automóveis de cada aluno');
        ...
        GerarGraficoPie(QtdDVD, opc17QtdeCadaCoisa, respMatutino, 25, labelsDvd, DadosDVD, 'qtd_DVD', 'Quantidade de DVD players');
        ...
        GerarGraficoPie(QtdTV, opc17QtdeCadaCoisa, respMatutino, 26, labelsQtdTV, DadosTV, 'qtd_TV', 'Quantidade de TVs de cada aluno');
        ...
        GerarGraficoPie(Qtd_Smartphones, opc17QtdeCadaCoisa, respMatutino, 27, labelsQtdSmartphone, DadosSmatphones, 'qtd_Smartphones', 'Quantidade de Smartphones de cada aluno');
        ...
        GerarGraficoBar(DomicilioTem, opcTemNoDomicilio, respMatutino, 28, labelsDomicilioTem, DadosDomicilioTem, 'Oque_tem_No_Domicilio', 'horizontalBar', 'Na casa de cada estudante tem');
        ...
        GerarGraficoPie(trabalha, opcTrabalha, respMatutino, 29, labelsTrabalho, DadosTrabalho, 'Trabalho', 'Você trabalha?');
        ...
        GerarGraficoPie(VinculoEmprego, opcVinculoEmprego, respMatutino, 30, labelsVinculo, DadosVinculo, 'Vinculo_Emprego', "Vinculo com o emprego");
        ...
        GerarGraficoPie(AreaTrabalho, opcAreaTrabalho, respMatutino, 31, labelsAreaTrabalho, DadosAreaTrabalho, 'Area_trabalho', "Qual a área do seu trabalho?");
        ...
        GerarGraficoPie(HorarioTrabalho, opcHorarioTrabalho, respMatutino, 32, labelsHorario, DadosHorario, 'Horario_Trabalho', "Horários de Trabalho");
        ...
        GerarGraficoPie(PlanoSaude, opcPlanoDeSaude, respMatutino, 34, labelsPlanoSaude, DadosPlanoSaude, 'Plano_Saude', 'Planos de Saúde');
        ...
        GerarGraficoPie(EscolaridadePai, opcEscolaridade, respMatutino, 35, LabelsEscolaPai, DadosEscolaridadePai, 'Escolaridade_Pai', 'Grau de Escolaridade do Pai dos Alunos');
        ...
        GerarGraficoPie(EscolaridadeMae, opcEscolaridade, respMatutino, 36, LabelsEscolaMae, DadosEscolaridadeMae, 'Escolaridade_Mae', 'Grau de Escolaridade da Mãe dos Alunos');
        ...
        GerarGraficoPie(EstudouEm, opcEstudou, respMatutino, 37, labelsEstudouEm, DadosEstudouEm, 'Estudou_Em', "Na sua vida escolar você estudou");
        ...
        GerarGraficoPie(FrequenciaMicrocomputadores, opcUsaMicroComp, respMatutino, 38, labelsFrequenciaComp, DadosFrequenciaComp, 'Frequencia_Microcomputadores', 'Com que frequência você utiliza microcomputadores?');
        ...
        GerarGraficoBar(OndeUtilizaMicro, opcOndeUsaMicroComp, respMatutino, 39, labelsUtilizaMicro, DadosOndeUtilizaMicro, 'Onde_Microcomputadores', 'horizontalBar', 'Onde você utiliza microcomputadores?');
        ...
        GerarGraficoBar(FinalidadeUtiliMicro, opcFinalizadeUsaMicroComp, respMatutino, 40, labelsFinalidadeUtiliza, DadosFinalidadeUtiliMicro, 'Finalidade_Microcomputadores', 'horizontalBar', 'Com qual finalidade você utiliza microcomputadores?');
        ...
        GerarGraficoPie(ConhecimentoInformatica, opcConhecimentoInformatica, respMatutino, 41, labelsInformatica, DadosConhecimentoInformatica, 'Conhecimento_Informatica', 'Conhecimento em Informática');
        ...
        GerarGraficoPie(ConhecimentoWindows, opcConhecimentoInformatica, respMatutino, 42, labelsWindows, DadosWindows, 'Conhecimento_Windows', 'Conhecimento no Windows');
        ...
        GerarGraficoPie(ConhecimentoLinux, opcConhecimentoInformatica, respMatutino, 43, labelsLinux, DadosLinux, 'Conhecimento_Linux', 'Conhecimento no Linux');
        ...
        GerarGraficoPie(ConhecimentoWord, opcConhecimentoInformatica, respMatutino, 44, labelsWord, DadosWord, 'Conhecimento_Word', 'Conhecimento em Editores de textos (Word, Writer, etc.)');
        ...
        GerarGraficoPie(ConhecimentoExcel, opcConhecimentoInformatica, respMatutino, 45, labelsExcel, DadosExcel, 'Conhecimento_Excel', 'Conhecimento em Planilhas eletrônicas (Excel, Calc, etc.)');
        ...
        GerarGraficoPie(ConhecimentoPowerPoint, opcConhecimentoInformatica, respMatutino, 46, labelsPowerPoint, DadosPowerPoint, 'Conhecimento_PowerPoint', 'Conhecimento em Apresentadores (Powerpoint, Impress, Prezzi, etc.)');
        ...
        GerarGraficoPie(ConhecimentoGestaoEmpresarial, opcConhecimentoInformatica, respMatutino, 47, labelsGestaoEmpresarial, DadosGestaoEmpresarial, 'Conhecimento_GestaoEmpresarial', 'Conhecimento em Sistemas de Gestão Empresaria');
        ...
        GerarGraficoPie(conhecimentoIngles, opcConhecimentoLinguas, respMatutino, 48, labelsInlges, DadosIngles, 'Ingles', 'Conhecimento em inglês');
        ...
        GerarGraficoPie(conhecimentoEspanhol, opcConhecimentoLinguas, respMatutino, 49, labelsEspanhol, DadosEspanhol, 'Espanhol', 'Conhecimento em Espanhol');
        ...
        GerarGraficoPie(conhecimentoIdioma, opcConhecimentoLinguas, respMatutino, 50, labelsIdioma, DadosIdioma, 'Outros', 'Conhecimento em outros idiomas');
        ...
        GerarGraficoPie(Televisores, opcBuscaInformação, respMatutino, 51, labelsTelevisores, DadosTelevisores, 'Televisores', 'Busca por informação no seguinte meio de comunicação(Televisores)');
        ...
        GerarGraficoPie(internet, opcBuscaInformação, respMatutino, 52, labelsInternet, DadosInternet, 'Internet', 'Busca por informação no seguinte meio de comunicação(Internet)');
        ...
        GerarGraficoPie(revistas, opcBuscaInformação, respMatutino, 53, labelsRevistas, DadosRevistas, 'Revistas', 'Busca por informação no seguinte meio de comunicação(Revistas)');
        ...
        GerarGraficoPie(jornais, opcBuscaInformação, respMatutino, 54, labelsJornais, DadosJornais, 'Jornais', 'Busca por informação no seguinte meio de comunicação(Jornais)');
        ...
        GerarGraficoPie(Radio, opcBuscaInformação, respMatutino, 55, labelsRadio, DadosRadio, 'Radio', 'Busca por informação no seguinte meio de comunicação(Rádio)');
        ...
        GerarGraficoPie(RedesSociais, opcBuscaInformação, respMatutino, 56, labelsRedesSociais, DadosRedesSociais, 'Redes_Sociais', 'Busca por informação no seguinte meio de comunicação(Redes Sociais)');
        ...
        GerarGraficoPie(ConversaComAmigos, opcBuscaInformação, respMatutino, 57, labelsConversaComAmigos, DadosConversaComAmigos, 'Conversas_com_Amigos', 'Busca por informação no seguinte meio de comunicação(Conversas com Amigos)');
        ...
        GerarGraficoPie(LeJornal, opcLeJornal, respMatutino, 58, labelsLeJornal, DadosLeJornal, 'Le_Jornal', ' Frequência que leem jornal');
        ...
        GerarGraficoBar(assuntosQueLeem, opcAssuntosJornal, respMatutino, 59, labelsAssuntosQueLeem, DadosAssuntosQueLeem, 'Assuntos_que_Le', 'horizontalBar', 'Assuntos que mais leem');
        ...
        GerarGraficoPie(QtdLivros, opcQtdLivros, respMatutino, 60, labelsQtdLivros, DadosQtdLivros, 'Qtd_Livros', 'Quantos livros cada aluno lê por ano (em média)');
        ...
        GerarGraficoBar(leLivros, opcLeLivros, respMatutino, 61, labelsLeLivros, DadosLeLivros, 'Le_Livros', 'horizontalBar', "Gêneros de livros preferidos de cada aluno");
        ...
        GerarGraficoPie(atividadesVolutaria, opcAtividadeVolun, respMatutino, 62, labelsAtividadeVoluntaria, DadosAtiviadeVoluntaria, 'Atividade_Voluntaria', "Dedica parte do tempo para atividades Voluntárias");
        ...
        GerarGraficoPie(religiao, opcReligiao, respMatutino, 63, lablesReligiao, DadosReligiao, 'Religiao', 'Religião');
        ...
        GerarGraficoBar(FontesEntretenimento, opcEntretenimento, respMatutino, 64, labelsFontesEntretenimento, DadosFontesEntretenimento, "Fontes_Entretenimento", 'horizontalBar', 'Fontes de Entretenimento');
        ...
        GerarGraficoBar(ConheceuFatec, opcConheceuFatec, respMatutino, 65, labelsConheceuFatec, DadosConheceuFatec, 'Conheceu_Fatec', 'horizontalBar', 'Como conheceu a FATEC Franca?')
        ...
        GerarGraficoBar(EscolheuCurso, opcEscolheuCurso, respMatutino, 66, labelsEscolheuCurso, DadosEscolheuCurso, 'Escolheu_Curso', 'horizontalBar', 'Porque você escolheu este curso?')
        ...
        GerarGraficoBar(ExpectativaCurso, opcExpectativa, respMatutino, 67, labelsExpectativaCurso, DadosExpectativaCurso, 'Expectativa_Curso', 'horizontalBar', 'Qual sua maior expectativa quanto ao curso?')
        ...
        GerarGraficoBar(ExpectativaFormar, opcFormar, respMatutino, 68, labelsExpectativaFormar, DadosExpectativaFormar, 'Expectativa_Formar', 'horizontalBar', 'Qual sua expectativa após se formar?')
        ...
        GerarGraficoPie(estudouNaFatec, opcEstudoNaEscola, respMatutino, 69, labelsEstudouFatec, DadosEstudouFatec, 'Estudou_Fatec', 'Você já estudou nesta escola?');
        ...
        GerarGraficoPie(cursoTecnico, opcCursoTecnico, respMatutino, 70, labelsCursoTecnico, DadosCursoTecnico, 'Curso_Tecnico', 'Você fez algum curso técnico?');
        ...
        GerarGraficoPie(transporte, opcTransporte, respMatutino, 71, labelsTransporte, DadosTransporte, 'Transporte', 'Meios de transportes')

        document.getElementById("MatutinoCidade").style.display = "block";
